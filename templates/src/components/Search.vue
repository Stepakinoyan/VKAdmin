<template style="font-size: 14px;">
  <header>
    <Menubar :model="items" class="flex justify-between border border-gosuslugi-border">
        <template #start>
  ...
  <main class="flex flex-col">
    ...
    <DataTable
        ...
        <Column field="members_count" sortable header="Участники" class="text-black text-xs text-center">
          <template #body="slotProps">
            <div class="flex justify-center items-center">
              <i v-if="slotProps.data.statistic.length <= 1 || slotProps.data.members_count === slotProps.data.statistic[slotProps.data.statistic.length - 2]?.members_count"></i>
              <i class="pi pi-arrow-up text-green-400 pb-1.4" v-else-if="slotProps.data.members_count > slotProps.data.statistic[slotProps.data.statistic.length - 2]?.members_count"></i>
              <i class="pi pi-arrow-down text-red-600 pb-1.4" v-else></i>
  ...
  data() {
    return {
      ...
      DataTableStyle: {
        ...
        footer: {
          class: ['font-bold', 'border-t-0 border-b border-x-0', 'p-4', 'bg-surface-50 dark:bg-surface-800', 'border-gosuslugi-border', 'text-surface-700 dark:text-white/80', 'rounded-b-lg']
        },
        filteroverlay: {
          class: ['absolute top-0 left-0', 'border-0 dark:border', 'rounded-md', 'shadow-md', 'min-w-[12.5rem]', 'bg-surface-0 dark:bg-surface-800', 'text-surface-800 dark:text-white/80', 'rounded-lg']
        },
      },
      selectedlevel: null,
