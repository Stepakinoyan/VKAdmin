...
Revision ID: 6523a0a9e606
Revises: 
Create Date: 2024-06-24 15:25:25.599216
...
def upgrade() -> None:
    ...
    sa.Column('average_fulfillment_percentage', sa.Integer(), nullable=True),
